...
function hero() {
  return (
    <section className="hero-sectoion  max-w-7xl mr-auto ml-auto">
      <div className="hero-container mt-[50px]">
        <div className="hero-content">
          <h1 className="hero-title text-center text-[72px] leading-[1] font-bold mb-[24px]">
            Create engaging interactive <br /> product demos{" "}
            <span className="text-blue-600">with AI</span>
          </h1>
          <p className="hero-discription text-center text-[20px] mb-[40px] text-gray-500 leading-[28px]">
